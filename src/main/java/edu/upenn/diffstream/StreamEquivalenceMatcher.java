...
public class StreamEquivalenceMatcher<IN> {
    ...
    private final StreamEquivalenceSink<IN> sinkLeft;
    private final Poset<IN> unmatchedItemsLeft;

    private final StreamEquivalenceSink<IN> sinkRight;
    ...
    public StreamEquivalenceSink<IN> getSinkLeft() {
        return sinkLeft;
    }

    public StreamEquivalenceSink<IN> getSinkRight() {
        return sinkRight;
    }
